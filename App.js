      ...
      <div className="container">
        <div className="header-container">
          ...
          <p className="sub-text">
            STREAM "BEETLEJUICE", A CULT CLASSIC FILM, USING A SCREENING PASSWORD FROM <br/> A 
            LIMITED EDITION NFT! START BY CONNECTING YOUR METAMASK WALLET TO THE FREE RINKEBY NETWORK.
          </p>
